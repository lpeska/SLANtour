...
final class Serial_library
{
    ...
    static private $ubytovani = array("bez ubytování", "stan", "chatky", "apartmány", "penzion", "hotel", "hotel 2*", "hotel 3*", "hotel 4*", "hotel 5*", "lázeòský dùm");
...
{
    //stavy zmeneny
    //static private $stav_rezervace = array("pøedbìžná poptávka","požadavek na rezervaci","opce","rezervace","záloha","zaplaceno","odbaveno","storno");
    static private $stav_rezervace = array("pøedbìžná poptávka", "požadavek na rezervaci", "opce", "rezervace", "záloha", "prodáno", "odbaveno", "storno","storno CK","VOUCHER");
