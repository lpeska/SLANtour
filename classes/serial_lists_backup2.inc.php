...
class Serial_list_component extends Serial_list{
    ...
    function __construct($typ, $podtyp, $nazev_zeme, $id_destinace, $zacatek, $pocet_zaznamu=POCET_ZAZNAMU, $type_of_query="recomended", $use_slevy=1, $id_serial="") {
        ...
        if($this->type_of_query=="recomended") {
            $attributes = "";
            $userExprs= array(
    ...
    /*}else if($this->type_of_query=="recomendedAggregated") {
            $attributes = "";
            $userExprs= "";
            ...
            switch ($moduloUser) {
                case 0:
                    echo "<!--dop0-->";
                    $objectExprs= array(
                        new ObjectExpression("", "ObjectRating", "288", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("deep_pageview"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>1, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) ),
                        new ObjectExpression("", "ObjectRating", "238", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("scroll"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>1 ) ) ),
                        new ObjectExpression("", "ObjectRating", "218", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("opened_vs_shown_fraction"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>1,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) ),
                        new ObjectExpression("", "ObjectRating", "213", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("pageview"), "eventsValuesList" => array( "pageview"=>1, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) ),
                        new ObjectExpression("", "ObjectRating", "205", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("object_opened_from_list"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>1, "object_ordered"=>0, "scroll"=>0 ) ) ),
                        new ObjectExpression("", "ObjectRating", "200", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("object_ordered"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>1, "scroll"=>0 ) ) )
                    ); 
                    break;
                case 1:
                    echo "<!--dop1-->";
                ...
                case 3:
                    echo "<!--dop3-->";
                    $objectExprs= array(
                       new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("object_ordered"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>1, "scroll"=>0 ) ) ),                       
                       new ObjectExpression("", "ObjectRating", "5", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("deep_pageview"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>1, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) ),
                       new ObjectExpression("", "ObjectRating", "5", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("scroll"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>1 ) ) )
                    ); 
                    break;
                case 4:
                    echo "<!--dop4-->";
                    $objectExprs= array(
                       new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("deep_pageview"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>1, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) )
                    ); 
                    break;
                case 5:
                    echo "<!--dop5-->";
                    $objectExprs= array(
                       new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*5, "aggregatedEventsList"=>array("scroll"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0 , "scroll"=>1) ) )
                    ); 
                    break;
                default:
                    break;
        ...
        */
            ...
            $userExprs= "";
            $user=ComponentCore::getUserId();
            $moduloUser = ($user*13) % 9;
            //$moduloUser = 8;
            switch ($moduloUser) {
                case 0:
                    echo "<!--dop0: same weights, all-->";
                    $objectExprs= array(
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("deep_pageview"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>1, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("scroll"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>1 ) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("opened_vs_shown_fraction"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>1,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("pageview"), "eventsValuesList" => array( "pageview"=>1, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("object_opened_from_list"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>1, "object_ordered"=>0, "scroll"=>0 ) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("object_ordered"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>1, "scroll"=>0 ) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("onpageTime"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0 , "scroll"=>0, "onpageTime"=>1) ) )

                    ); 
                    break;
                case 1:
                    echo "<!--dop1: same weights, first 3-->";
                    $objectExprs= array(
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("scroll"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>1 ) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("onpageTime"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0 , "scroll"=>0, "onpageTime"=>1) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("opened_vs_shown_fraction"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>1,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) )                        
                    ...
                    break;
                case 2:
                    echo "<!--dop2: priority, first 3-->";
                    $objectExprs= array(
                        new ObjectExpression("", "ObjectRating", "1000", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("scroll"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>1 ) ) ),
                        new ObjectExpression("", "ObjectRating", "100", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("onpageTime"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0 , "scroll"=>0, "onpageTime"=>1) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("opened_vs_shown_fraction"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>1,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) )                        
                   ); 
                    break;
                case 3:
                    echo "<!--dop3: scored, first 3-->";
                    $objectExprs= array(
                        new ObjectExpression("", "ObjectRating", "30", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("scroll"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>1 ) ) ),
                        new ObjectExpression("", "ObjectRating", "20", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("onpageTime"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0 , "scroll"=>0, "onpageTime"=>1) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "aggregatedEventsList"=>array("opened_vs_shown_fraction"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>1,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0 ) ) )                        
                   ); 
                    break;
                case 4:
                ...
                case 7:
                    ...
                    $userExprs= array(
                        new UserExpression("", "UserSimilarity", "3", "Standard", array("userID"=>ComponentCore::getUserId(), "noOfUsers"=>10, "implicitEventsList"=>array("scroll","onpageTime","order","pageview"), "eventsValuesList" => array( "pageview"=>1, "order"=>1 , "scroll"=>1, "onpageTime"=>1) ) ),
                    );
                    $objectExprs= array(
                        new ObjectExpression("", "UsersToObjectDataLookup", "100", "Standard", array( "noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "implicitEventsList"=>array("scroll","onpageTime","order","pageview"), "eventsValuesList" => array( "pageview"=>1,  "order"=>1 , "scroll"=>1, "onpageTime"=>1) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek), "aggregatedEventsList"=>array("scroll","onpageTime"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0 , "scroll"=>1, "onpageTime"=>1) ) )                   
                    ); 
                    break;
                case 8:
                    echo "<!--dop6: collaborative, first4, scored-->";
                    $userExprs= array(
                        new UserExpression("", "UserSimilarity", "3", "Standard", array("userID"=>ComponentCore::getUserId(), "noOfUsers"=>10, "implicitEventsList"=>array("scroll","onpageTime","order","pageview"), "eventsValuesList" => array( "pageview"=>2,  "order"=>2 , "scroll"=>4, "onpageTime"=>3) ) ),
                    );
                    $objectExprs= array(
                        new ObjectExpression("", "UsersToObjectDataLookup", "100", "Standard", array( "noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*10, "implicitEventsList"=>array("scroll","onpageTime","order","pageview"), "eventsValuesList" => array( "pageview"=>2, "order"=>2 , "scroll"=>4, "onpageTime"=>3) ) ),
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek), "aggregatedEventsList"=>array("scroll","onpageTime"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0 , "scroll"=>1, "onpageTime"=>1) ) )                        
                    ); 
                    break;
                default:
        ...
        /*}else if($this->type_of_query=="recomendedAggregated") {
            ...
            $userExprs= "";
            $user=ComponentCore::getUserId();
            $moduloUser = ($user*11) % 8;

            switch ($moduloUser) {
                case 0:
                    $objectExprs= array(
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*5, "aggregatedEventsList"=>array("opened_vs_shown_fraction","object_ordered"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>1,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0, "onpageTime"=>0 ) ) ),
                    ); 
                    break;
                case 1:
                    $objectExprs= array(
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*5, "aggregatedEventsList"=>array("object_ordered"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>1, "scroll"=>0, "onpageTime"=>0 ) ) ),
                   ); 
                    break;
                case 2:
                    $objectExprs= array(
                        new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*5, "aggregatedEventsList"=>array("pageview"), "eventsValuesList" => array( "pageview"=>1, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0, "onpageTime"=>0 ) ) ),
                    ); 
                    break;
                case 3:
                    $objectExprs= array(
                       new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*5, "aggregatedEventsList"=>array("deep_pageview"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>1, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0, "scroll"=>0, "onpageTime"=>0 ) ) ),
                    ); 
                    break;
                case 4:
                    $objectExprs= array(
                       new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*5, "aggregatedEventsList"=>array("object_opened_from_list"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>1, "object_ordered"=>0, "scroll"=>0, "onpageTime"=>0 ) ) ),
                    ); 
                    break;
                case 5:
                    $objectExprs= array(
                       new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*5, "aggregatedEventsList"=>array("scroll"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0 , "scroll"=>1, "onpageTime"=>0) ) ),
                    ); 
                    break;
                case 6:
                    $objectExprs= array(
                       new ObjectExpression("", "ObjectRating", "10", "Aggregated", array("noOfObjects"=>($this->pocet_zaznamu+$this->zacatek)*5, "aggregatedEventsList"=>array("onpageTime"), "eventsValuesList" => array( "pageview"=>0, "deep_pageview"=>0, "opened_vs_shown_fraction"=>0,"object_opened_from_list"=>0, "object_ordered"=>0 , "scroll"=>0, "onpageTime"=>1) ) ),
                    );
                    break;
                case 7:
                    $objectExprs= array();
