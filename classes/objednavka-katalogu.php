...
<head>
<title>
Objednávka katalogù | SLAN tour | Poznávací zájezdy 2020, Láznì, Dovolená u moøe léto 2019, fotbal, Formule 1, ATP Masters, olympiáda, biatlon
</title>  
  <meta http-equiv="cache-control" content="no-cache" />

<meta http-equiv="Content-Type" content="text/html; charset=windows-1250" />
<meta name="Keywords" content="objednávka katalogù, slan tour, dovolená, poznávací, zájezdy, láznì, lyžování, 2019"/>
<meta name="Description" content="SLAN tour: objednávka katalogù; Poznávací zájezdy 2020 (Francie, Nìmecko, Evropa, Mexiko, Indie, Rakousko, Itálie, Nepál, Namibie), Dovolená u moøe (Chorvatsko, Francie, Španìlsko, Mexiko - Cancun, Bali, SAE), 
 , láznì v Èechách, Moravì, Slovensku a Maïarsku, pobyty na horách i u vody,  2019, 2020, Premier League, Formule 1, tenis - vstupenky a zájezdy." />
...
function checkform(katalog){
	...
	if(document.form1.jmeno.value == ""){
		hlaska = hlaska + "Je tøeba vyplnit Vaše jméno!\n"
		var wrong = 1;
	}
	if(document.form1.prijmeni.value == ""){
		hlaska = hlaska + "Je tøeba vyplnit Vaše pøíjmení!\n"
		var wrong = 1;
	}
	if(document.form1.email.value == ""){
		hlaska = hlaska + "Je tøeba vyplnit Váš e-mail!\n"
		var wrong = 1;
	}
	if(document.form1.mesto.value == ""){
		hlaska = hlaska + "Je tøeba vyplnit Vaši adresu - mìsto!\n"
		var wrong = 1;
	}			
	if(document.form1.ulice.value == ""){
		hlaska = hlaska + "Je tøeba vyplnit Vaši adresu - ulici!\n"
		var wrong = 1;
	}			
	if(document.form1.psc.value == ""){
		hlaska = hlaska + "Je tøeba vyplnit Vaši adresu - PSÈ!\n"
		var wrong = 1;
	}	
	if(document.form1.kod.value == ""){
		hlaska = hlaska + "Je tøeba vyplnit SMS kód!\n"
		var wrong = 1;
	}		
	if(katalog == false){
		hlaska = hlaska + "Je tøeba vybrat alespoò jeden katalog!\n"
		var wrong = 1;
	}		
	if(wrong == 1){
	return hlaska;
...
prijmeni="<tr><td>pøíjmení:<\/td><td>" + document.form1.prijmeni.value + "<\/td><\/tr>\n";
email="<tr><td>email:<\/td><td>" + document.form1.email.value + "<\/td><\/tr>\n";
ulice="<tr><td>ulice:<\/td><td>" + document.form1.ulice.value + "<\/td><\/tr>\n";
mesto="<tr><td>mìsto:<\/td><td>" + document.form1.mesto.value + "<\/td><\/tr>\n";
psc="<tr><td>PSÈ:<\/td><td>" + document.form1.psc.value + "<\/td><\/tr>\n";
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle 
        <h1 class="pagetitle">Láznì a termální láznì</h1>-->
  <div class="column2-unit-left" > 

      <div class="zeme">
          <h3>KATALOG ZÁJEZDÙ A POBYTÙ</h3>
...
<table width="298">
    <tr><td colspan="4"><b>Nejžádanìjší zemì</b></td>
    </tr><tr>    
          <?php
...
<table width="298">
    <tr><td colspan="4"><b>Nejzajímavìjší sportovní akce</b></td>
    </tr><tr>    
          <?php
...
<h3>Objednávka katalogù CK SLAN tour</h3>
...
<form action="objednavka-katalog.php" method="post" name="form1" onsubmit="return odeslano();">
      <table align="center" cellpadding="1" cellspacing="0" width="100%">
        ...
        <tr>
          <th colspan="2">
           Objednané katalogy Vám zašleme poštou bìhem nìkolika dnù
          </th>
        </tr>
        <tr>
           <td  valign="top">   
                              ...
                              <table align="left" border="0"   class="round_light">
                                <tr valign="top"><td><input type="checkbox" name="katalog" value="Dovolená u moøe" /> Dovolená u moøe</td><td><a href="/pdf/katalog-dum.pdf">stáhnout PDF</a></td></tr>
                                ...
                                <tr valign="top"><td><input type="checkbox" name="katalog" value="Svìt na dosah - poznávací" /> Svìt na dosah - poznávací (evropské státy)</td><td><a href="https://issuu.com/slantour/docs/svet-na-dosah">prohlédnout  PDF</a></td></tr>
                                  <tr valign="top"><td><input type="checkbox" name="katalog" value="Vzdálené svìty - poznávací" /> Vzdálené svìty  - poznávací (mimoevropské státy)</td><td><a href="https://issuu.com/slantour/docs/vzdalene-svety_dcb90dc4dbc26e">prohlédnout PDF</a></td>
                               
                                <tr valign="top"><td><input type="checkbox" name="katalog" value="Láznì" /> Láznì</td><td><a href="https://issuu.com/slantour/docs/slan_katalog_lat_2017">stáhnout PDF</a></td></tr>
                                ...
                                <tr valign="top"><td colspan="2">
                                  <b><i>Katalogy zasíláme pouze za cenu poštovného.<br/>
                                    ...
                                    Katalogy jsou zasílány pouze na adresy v Èeské republice.
                                    </i></b>
                                    </td></tr>
                         </table>
...
<td valign="top" >	
									...
									<table border="0" cellpadding="5" cellspacing="5"   class="round_light">										
										<tr>
											<td  valign="top">
											<b><i><font color="#0000C0">Pro dokonèení objednávky katalogù je tøeba získat SMS kód. </font></i></b><br/><br/>
 SMS kód získáte zasláním SMS ve tvaru: <FONT COLOR="#0000D2">SLAN "vaše jméno"</FONT> (bez uvozovek, není nutné rozlišovat malá a velká písmena) na èíslo <b><FONT COLOR="#7E0000"><FONT SIZE=4>9021130</FONT></FONT></b> . Cena jedné SMS je 30 Kè (cena pokrývá náklady na poštovné). Ihned po odeslání SMS vám pøijde <U>zpìt zpráva s kódem</U>, který napište do pøíslušného pole ve formuláøi v rámeèku vlevo. Po vložení SMS kódu mùžete objednávku odeslat..<br/>
<br/>
<I>Cena této služby je 30 Kè vè. DPH za odeslanou SMS. Za službu odpovídá Advanced Telecom Services, s.r.o. Infolinka 776999199,  www.platmobilem.cz.</I><br/>
<br/>

Pøíklad tvaru  zaslané sms: <I><FONT COLOR="#00006F">slan novak</FONT></I>
