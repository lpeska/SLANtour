	...
	*/
        function finish() {
            ...
            if (!$this->get_error_message() or 1) {
                ...
                if (!$this->get_error_message()) {
                    ...
                    if($this->dotaz_slevy!=""){//chci vložit èasovou slevu
                            ...
                            if ($nalezena_aktualni_zaloha and !$existuje_druha_zaloha) {
                                ...
                                foreach ($dalsi_zaloha_castka as $key => $value) {
                                    ...
                                    if ($dalsi_zaloha_jednotka[$key] == "%") {
                                        $text = "Zálohu do výše $value % z ceny zájezdu uhraïte nejpozdìji " . $rozh_termin . " dní pøed odjezdem zájezdu.<br/>";
                                    } else {
                                        $text = "Zálohu do výše $value Kè za osobu uhraïte nejpozdìji " . $rozh_termin . " dní pøed odjezdem zájezdu.<br/>";
                                    }
                                    $doplatky_text.=$text;
                                }
    ...
    <table cellpadding=\"0\" cellspacing=\"0\" style=\"width:640px;margin-bottom:15px;font-size: 12px;\">
            <tr>
             ...
             (Souhlas se zpracováním osobních údajù v rozsahu jméno, pøíjmení, telefonní èíslo a e-mailová adresa za úèelem zasílání obchodních sdìlení. Cestovní kanceláø mùže zasílat obchodní sdìlení formou SMS, MMS, elektronické pošty, poštou èi sdìlovat telefonicky a to maximálnì 1x týdnì.)<br/><br/>
              Proti zasílání obchodních sdìlení je možno vznést kdykoliv námitku, a to buï na adrese cestovní kanceláøe nebo e-mailem zaslaným na adresu info@slantour.cz. V tomto pøípadì nebude cestovní kanceláø dále zasílat obchodní sdìlení, ani jinak zpracovávat vaše osobní údaje pro úèely pøímého marketingu.
            ...
            <ul>
                ...
                <li>Prohlašuji, že jsem oprávnìn uzavøít smlouvu za všechny osoby, uvedené v této smlouvì a odpovídám za úhradu celkové ceny zájezdu.</li>
                <li>Potvrzuji, že jsem se seznámil s pøíslušným <a href=\"https://www.slantour.cz/dokumenty/3126-povinne-informace-k-zajezdu.pdf\" target=\"_blank\">formuláøem dle vyhlášky è. 122/2018 Sb.</a>, o vzorech formuláøù pro jednotlivé typy zájezdù a spojených cestovních služeb, a s <a href=\"https://www.slantour.cz/dokumenty/3041-certifikat-pojistovny.pdf\" target=\"_blank\">dokladem o pojištìní CK proti úpadku</a>.</li>
            </ul>
...
/**
   ...
   function show_form_platby($celkova_castka){
      ...
      if(!$show_platba_kartou){
          ...
          $karta_text = "Platbu kartou bohužel nelze realizovat, protože nìkteré ze služeb, které objednáváte jsou vyprodané, pouze na dotaz, specifikovali jste termín mimo rozsah zájezdu, nebo je z jiného dùvodu nutné, aby dostupnost zájezdu nejprve potvrdil pracovník CK.<br/>";
      }else{
          $karta_enabled = "";
      ...
      $form = "
          <table class=\"sluzby\" style=\"width:100%;\"  cellpadding=\"2\" cellspacing=\"2\">
            ...
            <tr><td><img src=\"/img/platby/hotove.gif\" style=\"border:none;float:left;\" alt=\"Platba hotovì\"/>
                ...
                <b>Platbu hotovì mùžete provést na našich poboèkách v Praze, Slaném, Roudnici nad Labem</b><br/>
            ...
            <input name=\"zpusob_platby\" type=\"radio\" value=\"prevodem\" ".($_REQUEST["zpusob_platby"]=="prevodem" ? "checked=\"checked\"" : "")." /> 
              Bankovním pøevodem  <a href=\"#\" id=\"platba_prevodem_info\" style=\"border:none\"><img src=\"/img/platby/info.gif\"  alt=\"Informace o zpùsobu platby\" style=\"border:none\"/></a>
                <div id=\"hidden_platba_prevodem\" style=\"display:none;clear:left;\">Platbu pøevodem mùžete provést na náš úèet <b>19-6706930207 / 0100</b>. Jako variabilní symbol prosím uveïte èíslo objednávky (èíslo objednávky naleznete v potvrzovacím e-mailu, který Vám zašleme po dokonèení Vaší objednávky).<br/></div>          
            ...
            <input name=\"zpusob_platby\" type=\"radio\" value=\"prevodem_sk\" ".($_REQUEST["zpusob_platby"]=="prevodem" ? "checked=\"checked\"" : "")." /> 
              Bankovním pøevodem v eurech na Slovensku  <a href=\"#\" id=\"platba_prevodem_sk_info\" style=\"border:none\"><img src=\"/img/platby/info.gif\"  alt=\"Informace o zpùsobu platby\" style=\"border:none\"/></a>
                <div id=\"hidden_platba_prevodem_sk\" style=\"display:none;clear:left;\"><b>Pro klienty ze Slovenska je možné zaplatit zájezd v eurech na náš úèet u VÚB.</b><br/>
                    Celková cena zájezdu v eurech je <b>".round($celkova_castka/$centralni_data["kurz EUR"])." EUR</b>.<br/>
                    Platbu proveïte na úèet <b>".$centralni_data["platebni_spojeni:slovensko"]."</b>. Jako variabilní symbol prosím uveïte èíslo objednávky (èíslo objednávky naleznete v potvrzovacím e-mailu, který Vám zašleme po dokonèení Vaší objednávky).<br/></div>          
