<?php
/** 
* trida pro zobrazení seznamu cen zájezdu vč. kapacit
*/
/*------------------- SEZNAM CEN -------------------  */
...
class Seznam_cen extends Generic_list{
	...
	private $scriptStart;
        private $scriptEnd;
	//------------------- KONSTRUKTOR -----------------
	/** konstruktor třídy na základě id serialu a zajezdu*/
...
//------------------- METODY TRIDY -----------------	
	...
	/**zobrazeni formulare pro objednavku sluzeb*/
        function show_form_objednavka() {
            ...
            $vystup="   <br/>
                        <strong>Počet účastníků zájezdu:</strong> 
