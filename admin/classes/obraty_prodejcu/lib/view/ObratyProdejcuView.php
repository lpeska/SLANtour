...
class ObratyProdejcuView
{
    ...
    public static function loginErr()
    {
        ...
        $out .= self::htmlHead();
        $out .= ModulView::showLoginForm(ObratyProdejcuModel::$zamestnanec->get_uzivatelske_jmeno());
    ...
    protected static function htmlHead()
    {
        ...
        $out .= "<html>";
        $out .= "   <head>";
        $out .= "       <title>" . ObratyProdejcuModel::$core->show_nazev_modulu() . " | Administrace systému RSCK</title>";
        ...
        $out .= "       <script type='text/javascript' src='./classes/obraty_prodejcu/res/js/script.js'></script>";
        $out .= "   </head>";
        $out .= "   <body>";
