...
class OrganizaceView {
    ...
    public static function loginErr()
    {
        ...
        $out .= self::htmlHead();
        $out .= ModulView::showLoginForm(OrganizaceModel::$zamestnanec->get_uzivatelske_jmeno());
        $out .= OrganizaceModel::$zamestnanec->get_error_message();
        $out .= self::htmlFoot();
    ...
    protected static function htmlHead()
    {
        ...
        $out .= "<html>";
        $out .= "   <head>";
        $out .= "       <title>" . OrganizaceModel::$core->show_nazev_modulu() . " | Administrace systému RSCK</title>";
        ...
        $out .= "       <script type='text/javascript' src='./classes/financni_pohyby/res/js/FinancniPohybySerial.js'></script>";
        $out .= "       <script type='text/javascript' src='./classes/financni_pohyby/res/js/FinancniPohybyPrehled.js'></script>";
        $out .= "       <script type='text/javascript' src='./classes/financni_pohyby/res/js/script.js'></script>";
        $out .= "   </head>";
        $out .= "   <body>";
