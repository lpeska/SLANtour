...
class AFakturaProvizeView
{
    ...
    public static function loginErr()
    {
        ...
        $out .= self::htmlHead();
        $out .= ModulView::showLoginForm(AFakturaProvizeModel::$zamestnanec->get_uzivatelske_jmeno());
    ...
    protected static function htmlHead()
    {
        ...
        $out .= "<html>";
        $out .= "   <head>";
        $out .= "       <title>" . AFakturaProvizeModel::$core->show_nazev_modulu() . " | Administrace systému RSCK</title>";
...
//        $out .= "       <script type='text/javascript' src='./classes/a_faktura_provize/res/js/script.js'></script>";
        $out .= "   </head>";
        $out .= "   <body>";
