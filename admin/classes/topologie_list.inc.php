...
/**na zaklade textoveho vstupu vytvori korektni cast retezce pro order by*/
	...
	function show_filtr(){
		...
		$vystup="
			...
			<table class=\"filtr\">
				<tr>
					<td>Název topologie: ".$input_nazev."</td>
					<td>".$submit."</td>
				</tr>
			</table>
			</form>
	...
	function show_list_item($typ_zobrazeni){
		...
		if($typ_zobrazeni=="tabulka"){
                    ...
                    $vypis = $vypis."
                                                    ...
                                                    <td class=\"nazev\">".$this->radek["poznamka"]."</td>
                                                    <td class=\"menu\">
                                                              <a href=\"".$adresa_modulu."?id_serial=".$_GET["id_serial"]."&id_zajezd=".$_GET["id_zajezd"]."&id_topologie=".$this->radek["id_topologie"]."&amp;typ=topologie&amp;pozadavek=add_new\">pøidat topologii k zájezdu</a>";
                    $vypis = $vypis."  </td>
                                            </tr>";
