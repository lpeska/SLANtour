...
class FinancniPohybyView
{
    ...
    public static function loginErr()
    {
        ...
        $out .= self::htmlHead();
        $out .= ModulView::showLoginForm(FinancniPohybyModel::$zamestnanec->get_uzivatelske_jmeno());
    ...
    protected static function htmlHead()
    {
        ...
        $out .= "<html>";
        $out .= "   <head>";
        $out .= "       <title>" . FinancniPohybyModel::$core->show_nazev_modulu() . " | Administrace systému RSCK</title>";
