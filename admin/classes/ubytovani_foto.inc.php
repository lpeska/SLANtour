	...
	function show_list_item($typ_zobrazeni){
		if($typ_zobrazeni=="tabulka"){
			...
			if(!$this->get_zakladni_foto()){
				$zakl_foto="<a href=\"?id_ubytovani=".$this->get_id_ubytovani()."&amp;id_foto=".$this->get_id_foto()."&amp;typ=foto&amp;pozadavek=update&amp;zakladni_foto=1\">zmìnit na základní foto</a> | ";
			}else{
				$zakl_foto="<a href=\"?id_ubytovani=".$this->get_id_ubytovani()."&amp;id_foto=".$this->get_id_foto()."&amp;typ=foto&amp;pozadavek=update&amp;zakladni_foto=0\">odznaèit základní</a> | ";
			}
