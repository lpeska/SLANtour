...
class ObjednavkyView
{
    ...
    public static function loginErr()
    {
        ...
        $out .= self::htmlHead();
        $out .= ModulView::showLoginForm(ObjednavkyModel::$zamestnanec->get_uzivatelske_jmeno());
        $out .= ObjednavkyModel::$zamestnanec->get_error_message();
        $out .= self::htmlFoot();
    ...
    protected static function htmlHead()
    {
        ...
        $out .= "<html>";
        $out .= "   <head>";
        $out .= "       <title>" . ObjednavkyModel::$core->show_nazev_modulu() . " | Administrace systému RSCK</title>";
        ...
        $out .= "       <link rel='stylesheet' type='text/css' href='/global/res/date-range-picker/daterangepicker-bs3.css' media='all'/>";
