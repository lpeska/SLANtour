...
require_once "./classes/modul_list.inc.php"; //seznamy klientù
require_once "./classes/modul.inc.php"; //detail seriálu
...
//promenna adress obsahuje pozadavek na reload stranky (adresu)	
    ...
    if ($_GET["typ"] == "modul_list") {
        ...
        if ($_GET["pozadavek"] == "create") {
            ...
            $dotaz = new Modul("create", $zamestnanec->get_id(), "", $_POST["nazev_modulu"], $_POST["adresa_modulu"], $_POST["povoleno"], $_POST["typ_modulu"], $_POST["napoveda"], "", $_POST["modul_group"]);
            ...
            $dotaz = new Modul("update", $zamestnanec->get_id(), $_GET["id_modul"], $_POST["nazev_modulu"], $_POST["adresa_modulu"], $_POST["povoleno"], $_POST["typ_modulu"], $_POST["napoveda"], "", $_POST["modul_group"]);
            if (!$dotaz->get_error_message()) {
                //vytvorime adresu dalsi stranku - automaticky nactenou pres http location
                $adress = $_SERVER['SCRIPT_NAME'] . "?typ=modul_list";
                $_SESSION["hlaska"] = $_SESSION["hlaska"] . $dotaz->get_ok_message();
            ...
            $dotaz = new Modul("delete", $zamestnanec->get_id(), $_GET["id_modul"]);
            //vytvorime adresu dalsi stranku - automaticky nactenou pres http location
            $adress = $_SERVER['SCRIPT_NAME'] . "?typ=modul_list";
            if (!$dotaz->get_error_message()) {
                $_SESSION["hlaska"] = $_SESSION["hlaska"] . $dotaz->get_ok_message();
    ...
    <div class="main-wrapper">
        <div class="main">
            ...
            if ($_GET["typ"] == "modul_list") {
                ...
                $modul_list = new Modul_list($_SESSION["modul_order_by"]);
                ...
                <?
                $modul = new Modul("new", $zamestnanec->get_id(), "", $_POST["nazev_modulu"], $_POST["adresa_modulu"], $_POST["povoleno"], $_POST["typ_modulu"], $_POST["napoveda"], $_GET["pozadavek"]);
                ...
                $modul = new Modul("edit", $zamestnanec->get_id(), $_GET["id_modul"], $_POST["nazev_modulu"], $_POST["adresa_modulu"], $_POST["povoleno"], $_POST["typ_modulu"], $_POST["napoveda"], $_GET["pozadavek"]);
